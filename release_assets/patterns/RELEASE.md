...
**Pinned now:** version 1 (builder 4). It was made from RealPersonaChat, Aozora Bunko and Japanese
Wikipedia, and its zip is 26.8 MB.
...
**In this folder, waiting to be committed:** version 2 (builder 5, 2026-09-25). It adds modern news
from the Leipzig Corpora Collection, and its zip is 29.2 MB.
